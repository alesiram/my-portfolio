...
const projectData = [
    ...
    id: 1,
    title: 'clockTimeCal',
    image: 'src/components/images/projectImgs/timeCal.jpg',
    ...
    id: 2,
    title: "Langton's Ant",
    image: 'src/components/images/projectImgs/langtonAnt.png',
    ...
    image: 'src/components/images/projectImgs/HasamiShogiGame.png',
    ...
    image: 'src/components/images/projectImgs/StringPrimMac.png',
